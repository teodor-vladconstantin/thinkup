...
import styles from "../../../styles/AddAdminPopUp.module.css";
import PopUpContainer from "../Containers/PopUpContainer";
import AccentButton from "../Buttons/AccentButton";
import CancelButton from "../Buttons/CancelButton";
import SearchBar from '../FormElems/SearchBar';
import axios from "axios";
import ScrollContainer from "../Containers/ScrollContainer";
import CircleAddButton from "../Buttons/CircleAddButton";

const AddAdminPopUp = ({ className, close,refresh,id}) => {
    ...
    return (
        <PopUpContainer className={styles.AddAdminPopUp + " " + className}>
            ...
            <ScrollContainer className={styles.UsersList}>
            ...
            <div className={styles.NewAdminButtonDiv}>
                <AccentButton text="Add" onClick={() => addAdmin()}>
                    <svg
                        width="21"
                        height="22"
                        viewBox="0 0 21 22"
