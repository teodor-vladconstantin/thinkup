...
const ConfirmationPopUp = ({ className, message, close, confirmed }) => {
    return (
        <PopUpContainer className={styles.ConfirmationPopUp + " " + className}>
            <p>
                Are you sure you want to <span>{message}</span>?
            </p>

            <div className={styles.ConfirmationButtons}>
                <AccentButton text="Log me out" onClick={() => confirmed()}>
                    <svg
                        width="21"
                        height="22"
                        viewBox="0 0 21 22"
