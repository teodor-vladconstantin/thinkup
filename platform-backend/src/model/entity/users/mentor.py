...
class Mentor (Student):
    def __init__(self, id: str, name: str, search_term: str, profile_picture: str, profile_picture_extension: str, cover_picture: str, cover_picture_extension: str,
        ...
        super().__init__(id, name, search_term, profile_picture, profile_picture_extension, cover_picture, cover_picture_extension, email, description, settings, perms, activity, puzzle, personal_objectives, social_connections, awards, fav_files)
